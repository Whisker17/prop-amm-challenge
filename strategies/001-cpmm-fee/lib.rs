...
/// Constant-product AMM with a single free parameter: the fee, as
/// `FEE_NUMERATOR / FEE_DENOMINATOR`. This is the 0-line (docs/DESIGN.md §2.8) — the fee is
/// not fitted here (WHI-1194); it is committed at the starter's own value until then.
