...
| 002-normalizer-as-submission | 002 Normalizer As Submission | ported (faithful reimplementation of `crates/shared/src/normalizer.rs`) | measured (WHI-1194) — no free parameter, the symmetric zero | avg edge 200.08, seeds `0..=999`, 10,000 steps, native (`NOTES.md` § Measured numbers) |
